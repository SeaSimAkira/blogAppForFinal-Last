...
<body class="bg-pattern min-h-screen flex items-center justify-center p-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" id="password"
                                class="block w-full pl-11 pr-12 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200"
    ...
    <script>
        ...
        togglePassword.addEventListener('click', function () {
            ...
            // Tell Lucide to refresh the specific icon
            lucide.createIcons();
        });
    </script>
